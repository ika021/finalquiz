...
import com.example.finalquiz.ChangePasswordActivity
import com.example.finalquiz.LoginActivity
import com.example.finalquiz.R
import com.example.finalquiz.UserInfo
...
class UserFragment : Fragment(R.layout.fragment_user) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        logoutText.setOnClickListener {
            ...
            editor.clear()
            editor.apply()
            startActivity(Intent(this@UserFragment.requireContext(), LoginActivity::class.java))

        }

        changePassTextView.setOnClickListener {

            startActivity(Intent(this@UserFragment.requireContext(), ChangePasswordActivity::class.java))
